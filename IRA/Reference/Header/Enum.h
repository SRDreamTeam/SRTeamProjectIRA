...
<<<<<<< HEAD
enum OBJ_TYPE { OBJ_PLAYER, OBJ_MONSTER, OBJ_GHOST, OBJ_ARROW, OBJ_BOW, OBJ_ETC, OBJ_BULLET, OBJ_EFFECT, OBJ_LANDSCAPE, OBJ_NONE, OBJ_END };
=======
enum OBJ_TYPE { OBJ_PLAYER, OBJ_MONSTER, OBJ_GHOST, OBJ_ARROW, OBJ_BOW, OBJ_ETC, OBJ_BULLET, OBJ_EFFECT , OBJ_NONE , OBJ_END };
>>>>>>> Boss/Doewole3
