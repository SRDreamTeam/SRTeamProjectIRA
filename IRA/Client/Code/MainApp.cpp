...
HRESULT CMainApp::Ready_DefaultSetting(LPDIRECT3DDEVICE9 * ppGraphicDev)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Font((*ppGraphicDev), L"Font_Title", L"Yoon® 민국", 18 , 24, FW_BOLD), E_FAIL);
	FAILED_CHECK_RETURN(Engine::Ready_Font((*ppGraphicDev), L"Font_Title_2", L"Yoon® 민국", 15, 20, FW_BOLD), E_FAIL);



	// 출력 : Engine::Render_Font(L"Font_Default", m_pLoading->Get_String(), &_vec2(20.f, 20.f), D3DXCOLOR(1.f, 1.f, 1.f, 1.f));
